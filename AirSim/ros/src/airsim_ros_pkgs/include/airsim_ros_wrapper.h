...
#include <airsim_ros_pkgs/EnableManualFocus.h>
#include <airsim_ros_pkgs/Takeoff.h>
#include <airsim_ros_pkgs/TakeoffGroup.h>
#include <airsim_ros_pkgs/MoveOnPath.h>
#include <airsim_ros_pkgs/SetObjectPose.h>
#include <airsim_ros_pkgs/GetObjectPose.h>
...
private:
    ...
    public:
        ...
        std::vector<IntrinsicsPublisher> intrinsics_pub_vec;
        std::vector<IntrinsicsSubscriber> intrinsics_sub_vec;
        std::vector<ros::ServiceServer> enable_manual_focus_srv_vec;
    ...
    void update_intrinsics_cb(const airsim_ros_pkgs::IntrinsicsCamera::ConstPtr& intrinsics_cmd_msg, const std::string& vehicle_name, const std::string& camera_name);//, const std::string& vehicle_name, const std::string& camera_name);
    bool enable_manual_focus_srv_cb(airsim_ros_pkgs::EnableManualFocus::Request& request, airsim_ros_pkgs::EnableManualFocus::Response& response, const std::string& vehicle_name, const std::string& camera_name);
    bool get_object_pose_srv_cb(airsim_ros_pkgs::GetObjectPose::Request& request,airsim_ros_pkgs::GetObjectPose::Response& response);
    bool set_object_pose_srv_cb(airsim_ros_pkgs::SetObjectPose::Request& request,airsim_ros_pkgs::SetObjectPose::Response& response);
    bool move_on_path_srv_cb(airsim_ros_pkgs::MoveOnPath::Request& request, airsim_ros_pkgs::MoveOnPath::Response& response, const std::string& vehicle_name);
...
private:
    ...
    ros::ServiceServer get_object_pose_srvr_;
    ros::ServiceServer set_object_pose_srvr_;
